...
abstract class Author implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Bookstore\\Map\\AuthorTableMap';
    ...
    /**
     * Initializes internal state of Bookstore\Base\Author object.
     */
     ...
     * @return $this|\Bookstore\Author The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Bookstore\\Author'), 0, $e);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Bookstore\Author The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Bookstore\Author (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Bookstore\Author Clone of current object.
     * @throws PropelException
     */
