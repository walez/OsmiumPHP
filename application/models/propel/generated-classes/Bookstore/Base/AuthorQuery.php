...
use \Exception;
use \PDO;
use Bookstore\Author as ChildAuthor;
use Bookstore\AuthorQuery as ChildAuthorQuery;
use Bookstore\Map\AuthorTableMap;
...
abstract class AuthorQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Bookstore\Base\AuthorQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'bookstore', $modelName = '\\Bookstore\\Author', $modelAlias = null)
    {
