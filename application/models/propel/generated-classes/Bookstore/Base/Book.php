...
abstract class Book implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Bookstore\\Map\\BookTableMap';
    ...
    /**
     * Initializes internal state of Bookstore\Base\Book object.
     */
     ...
     * @return $this|\Bookstore\Book The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Bookstore\\Book'), 0, $e);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Bookstore\Book The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Bookstore\Book (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Bookstore\Book Clone of current object.
     * @throws PropelException
     */
