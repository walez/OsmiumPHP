...
use \Exception;
use \PDO;
use Bookstore\Book as ChildBook;
use Bookstore\BookQuery as ChildBookQuery;
use Bookstore\Map\BookTableMap;
 ...
 *
 * @method     \Bookstore\PublisherQuery|\Bookstore\AuthorQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class BookQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Bookstore\Base\BookQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'bookstore', $modelName = '\\Bookstore\\Book', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \Bookstore\Publisher object
     *
     * @param \Bookstore\Publisher|ObjectCollection $publisher The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($publisher instanceof \Bookstore\Publisher) {
            return $this
            ...
            throw new PropelException('filterByPublisher() only accepts arguments of type \Bookstore\Publisher or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Bookstore\PublisherQuery A secondary query class using the current class as primary query
     */
    public function usePublisherQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinPublisher($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Publisher', '\Bookstore\PublisherQuery');
    }

    /**
     * Filter the query by a related \Bookstore\Author object
     *
     * @param \Bookstore\Author|ObjectCollection $author The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($author instanceof \Bookstore\Author) {
            return $this
            ...
            throw new PropelException('filterByAuthor() only accepts arguments of type \Bookstore\Author or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Bookstore\AuthorQuery A secondary query class using the current class as primary query
     */
    public function useAuthorQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinAuthor($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Author', '\Bookstore\AuthorQuery');
    }
