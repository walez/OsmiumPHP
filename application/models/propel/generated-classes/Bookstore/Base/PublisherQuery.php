...
use \Exception;
use \PDO;
use Bookstore\Publisher as ChildPublisher;
use Bookstore\PublisherQuery as ChildPublisherQuery;
use Bookstore\Map\PublisherTableMap;
 ...
 *
 * @method     \Bookstore\BookQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class PublisherQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Bookstore\Base\PublisherQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'bookstore', $modelName = '\\Bookstore\\Publisher', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \Bookstore\Book object
     *
     * @param \Bookstore\Book|ObjectCollection $book the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    {
        if ($book instanceof \Bookstore\Book) {
            return $this
            ...
            throw new PropelException('filterByBook() only accepts arguments of type \Bookstore\Book or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Bookstore\BookQuery A secondary query class using the current class as primary query
     */
    public function useBookQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinBook($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Book', '\Bookstore\BookQuery');
    }
