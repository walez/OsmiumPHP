...
class BookTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Bookstore\\Book');
    ...
    {
        $this->addRelation('Publisher', '\\Bookstore\\Publisher', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':publisher_id',
    1 => ':id',
        ...
        $this->addRelation('Author', '\\Bookstore\\Author', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':author_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Bookstore\Book) { // it's a model object
