...
namespace Bookstore\Map;

use Bookstore\Publisher;
use Bookstore\PublisherQuery;
...
class PublisherTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Bookstore.Map.PublisherTableMap';
     ...
     */
    const OM_CLASS = '\\Bookstore\\Publisher';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Bookstore.Publisher';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Bookstore\\Publisher');
    ...
    {
        $this->addRelation('Book', '\\Bookstore\\Book', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':publisher_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Bookstore\Publisher) { // it's a model object
